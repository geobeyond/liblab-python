...
class UtahCityLocationsService(BaseService):

    @cast_models
    def describe_utah_city_locations_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/utah_city_locations",
    ...
    @cast_models
    def get_utah_city_locations_features(
        self,
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetUtahCityLocationsFeaturesProperties] = None,
        ...
        co_seat: str = None,
        pop_1999: float = None,
        pop_sym_99: float = None,
        pop_2000: float = None,
        pop_sym_00: float = None,
        state: str = None,
    ) -> FeatureCollectionGeoJson:
        """Data from the state of Utah. Standard demo dataset from the deegree WFS server that is used as backend WFS.
        ...
        :type properties: List[GetUtahCityLocationsFeaturesProperties], optional
        ...
        :param co_seat: co_seat, defaults to None
        :type co_seat: str, optional
        :param pop_1999: pop_1999, defaults to None
        :type pop_1999: float, optional
        :param pop_sym_99: pop_sym_99, defaults to None
        :type pop_sym_99: float, optional
        :param pop_2000: pop_2000, defaults to None
        :type pop_2000: float, optional
        :param pop_sym_00: pop_sym_00, defaults to None
        :type pop_sym_00: float, optional
        ...
        Validator(str).is_optional().validate(co_seat)
        Validator(float).is_optional().validate(pop_1999)
        Validator(float).is_optional().validate(pop_sym_99)
        Validator(float).is_optional().validate(pop_2000)
        Validator(float).is_optional().validate(pop_sym_00)
        Validator(str).is_optional().validate(state)

        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/utah_city_locations/items",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
            ...
            .add_query("CO_SEAT", co_seat, explode=False)
            .add_query("POP_1999", pop_1999, explode=False)
            .add_query("POP_SYM_99", pop_sym_99, explode=False)
            .add_query("POP_2000", pop_2000, explode=False)
            .add_query("POP_SYM_00", pop_sym_00, explode=False)
            .add_query("STATE", state, explode=False)
            .serialize()
            .set_method("GET")
        )
    ...
    @cast_models
    def options_utah_city_locations_features(self) -> Any:
        """Data from the state of Utah. Standard demo dataset from the deegree WFS server that is used as backend WFS.
    ...
    @cast_models
    def get_utah_city_locations_feature(
        self,
        feature_id: str,
        crs: str = None,
        f: GetLandingPageF = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/utah_city_locations/items/{{featureId}}",
                self.get_default_headers(),
            )
    ...
    @cast_models
    def options_utah_city_locations_feature(self, feature_id: str) -> Any:
        """Data from the state of Utah. Standard demo dataset from the deegree WFS server that is used as backend WFS.
    ...
    @cast_models
    def get_utah_city_locations_queryables(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Data from the state of Utah. Standard demo dataset from the deegree WFS server that is used as backend WFS.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/utah_city_locations/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def get_utah_city_locations_schema(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Data from the state of Utah. Standard demo dataset from the deegree WFS server that is used as backend WFS.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/utah_city_locations/schema",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
