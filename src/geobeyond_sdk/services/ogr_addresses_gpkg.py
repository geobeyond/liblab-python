...
class OgrAddressesGpkgService(BaseService):

    @cast_models
    def describe_ogr_addresses_gpkg_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_gpkg",
    ...
    @cast_models
    def get_ogr_addresses_gpkg_features(
        self,
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetOgrAddressesGpkgFeaturesProperties] = None,
        ...
        :type properties: List[GetOgrAddressesGpkgFeaturesProperties], optional
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_gpkg/items",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def options_ogr_addresses_gpkg_features(self) -> Any:
        """Dutch addresses subset.
    ...
    @cast_models
    def get_ogr_addresses_gpkg_feature(
        self,
        feature_id: str,
        crs: str = None,
        f: GetLandingPageF = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_gpkg/items/{{featureId}}",
                self.get_default_headers(),
            )
    ...
    @cast_models
    def options_ogr_addresses_gpkg_feature(self, feature_id: str) -> Any:
        """Dutch addresses subset.
    ...
    @cast_models
    def get_ogr_addresses_gpkg_queryables(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Dutch addresses subset.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_gpkg/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def get_ogr_addresses_gpkg_schema(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Dutch addresses subset.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_gpkg/schema",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
