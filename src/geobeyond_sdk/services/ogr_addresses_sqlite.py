...
class OgrAddressesSqliteService(BaseService):

    @cast_models
    def describe_ogr_addresses_sqlite_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_sqlite",
    ...
    @cast_models
    def get_ogr_addresses_sqlite_features(
        self,
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetOgrAddressesSqliteFeaturesProperties] = None,
        ...
        :type properties: List[GetOgrAddressesSqliteFeaturesProperties], optional
        ...
        :param straatnaam: straatnaam, defaults to None
        :type straatnaam: str, optional
        :param huisnummer: huisnummer, defaults to None
        :type huisnummer: str, optional
        :param huisletter: huisletter, defaults to None
        :type huisletter: str, optional
        :param woonplaats: woonplaats, defaults to None
        :type woonplaats: str, optional
        :param postcode: postcode, defaults to None
        :type postcode: str, optional
        :param toevoeging: toevoeging, defaults to None
        :type toevoeging: str, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        ...
        Validator(str).is_optional().validate(straatnaam)
        Validator(str).is_optional().validate(huisnummer)
        Validator(str).is_optional().validate(huisletter)
        Validator(str).is_optional().validate(woonplaats)
        Validator(str).is_optional().validate(postcode)
        Validator(str).is_optional().validate(toevoeging)

        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_sqlite/items",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
            ...
            .add_query("straatnaam", straatnaam, explode=False)
            .add_query("huisnummer", huisnummer, explode=False)
            .add_query("huisletter", huisletter, explode=False)
            .add_query("woonplaats", woonplaats, explode=False)
            .add_query("postcode", postcode, explode=False)
            .add_query("toevoeging", toevoeging, explode=False)
            .serialize()
            .set_method("GET")
        )
    ...
    @cast_models
    def options_ogr_addresses_sqlite_features(self) -> Any:
        """Dutch addresses subset.
    ...
    @cast_models
    def get_ogr_addresses_sqlite_feature(
        self,
        feature_id: str,
        crs: str = None,
        f: GetLandingPageF = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_sqlite/items/{{featureId}}",
                self.get_default_headers(),
            )
    ...
    @cast_models
    def options_ogr_addresses_sqlite_feature(self, feature_id: str) -> Any:
        """Dutch addresses subset.
    ...
    @cast_models
    def get_ogr_addresses_sqlite_queryables(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Dutch addresses subset.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_sqlite/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def get_ogr_addresses_sqlite_schema(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Dutch addresses subset.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_addresses_sqlite/schema",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
