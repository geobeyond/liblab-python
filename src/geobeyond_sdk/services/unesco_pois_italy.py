...
class UnescoPoisItalyService(BaseService):

    @cast_models
    def describe_unesco_pois_italy_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/unesco_pois_italy",
    ...
    @cast_models
    def get_unesco_pois_italy_features(
        self,
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetUnescoPoisItalyFeaturesProperties] = None,
        ...
        :type properties: List[GetUnescoPoisItalyFeaturesProperties], optional
        ...
        :param cod_unesco: cod_unesco, defaults to None
        :type cod_unesco: str, optional
        :param sito: sito, defaults to None
        :type sito: str, optional
        :param seriale: seriale, defaults to None
        :type seriale: int, optional
        :param cod_compon: cod_compon, defaults to None
        :type cod_compon: str, optional
        :param componente: componente, defaults to None
        :type componente: str, optional
        :param tipo_area: tipo_area, defaults to None
        :type tipo_area: str, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        ...
        Validator(str).is_optional().validate(cod_unesco)
        Validator(str).is_optional().validate(sito)
        Validator(int).is_optional().validate(seriale)
        Validator(str).is_optional().validate(cod_compon)
        Validator(str).is_optional().validate(componente)
        Validator(str).is_optional().validate(tipo_area)

        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/unesco_pois_italy/items",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
            ...
            .add_query("cod_unesco", cod_unesco, explode=False)
            .add_query("sito", sito, explode=False)
            .add_query("seriale", seriale, explode=False)
            .add_query("cod_compon", cod_compon, explode=False)
            .add_query("componente", componente, explode=False)
            .add_query("tipo_area", tipo_area, explode=False)
            .serialize()
            .set_method("GET")
        )
    ...
    @cast_models
    def options_unesco_pois_italy_features(self) -> Any:
        """Unesco Points of Interest in Italy. Using GeoSolutions GeoServer WFS demo-server as backend WFS.
    ...
    @cast_models
    def get_unesco_pois_italy_feature(
        self,
        feature_id: str,
        crs: str = None,
        f: GetLandingPageF = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/unesco_pois_italy/items/{{featureId}}",
                self.get_default_headers(),
            )
    ...
    @cast_models
    def options_unesco_pois_italy_feature(self, feature_id: str) -> Any:
        """Unesco Points of Interest in Italy. Using GeoSolutions GeoServer WFS demo-server as backend WFS.
    ...
    @cast_models
    def get_unesco_pois_italy_queryables(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Unesco Points of Interest in Italy. Using GeoSolutions GeoServer WFS demo-server as backend WFS.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/unesco_pois_italy/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def get_unesco_pois_italy_schema(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Unesco Points of Interest in Italy. Using GeoSolutions GeoServer WFS demo-server as backend WFS.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/unesco_pois_italy/schema",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
