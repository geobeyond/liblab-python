...
class OgrGpkgWalesStationsService(BaseService):

    @cast_models
    def describe_ogr_gpkg_wales_stations_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_stations",
    ...
    @cast_models
    def get_ogr_gpkg_wales_stations_features(
        self,
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetOgrGpkgWalesStationsFeaturesProperties] = None,
        ...
        :type properties: List[GetOgrGpkgWalesStationsFeaturesProperties], optional
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_stations/items",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def options_ogr_gpkg_wales_stations_features(self) -> Any:
        """Railway stations in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
    ...
    @cast_models
    def get_ogr_gpkg_wales_stations_feature(
        self,
        feature_id: str,
        crs: str = None,
        f: GetLandingPageF = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_stations/items/{{featureId}}",
                self.get_default_headers(),
            )
    ...
    @cast_models
    def options_ogr_gpkg_wales_stations_feature(self, feature_id: str) -> Any:
        """Railway stations in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
    ...
    @cast_models
    def get_ogr_gpkg_wales_stations_queryables(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Railway stations in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_stations/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def get_ogr_gpkg_wales_stations_schema(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Railway stations in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_stations/schema",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
