...
class ObsService(BaseService):
    ...
    def describe_obs_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/collections/obs", self.get_default_headers())
    ...
    def get_obs_features(
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetObsFeaturesProperties] = None,
        ...
        :type properties: List[GetObsFeaturesProperties], optional
        ...
        :param stn_id: stn_id, defaults to None
        :type stn_id: int, optional
        ...
        Validator(GetObsFeaturesProperties).is_array().is_optional().validate(
            properties
        )
        ...
        Validator(int).is_optional().validate(stn_id)
        Validator(str).is_optional().validate(datetime_)
        Validator(float).is_optional().validate(value)

        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/obs/items", self.get_default_headers()
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
            ...
            .add_query("stn_id", stn_id, explode=False)
            .add_query("datetime", datetime_, explode=False)
            .add_query("value", value, explode=False)
            .serialize()
            .set_method("GET")
        )
    ...
    @cast_models
    def options_obs_features(self) -> Any:
        """Observations
    ...
    def get_obs_feature(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/obs/items/{{featureId}}",
    ...
    @cast_models
    def options_obs_feature(self, feature_id: str) -> Any:
        """Observations
    ...
    def get_obs_queryables(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/obs/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    def get_obs_schema(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/obs/schema", self.get_default_headers()
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
            .serialize()
