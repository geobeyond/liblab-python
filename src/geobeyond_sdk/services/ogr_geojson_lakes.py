...
class OgrGeojsonLakesService(BaseService):

    @cast_models
    def describe_ogr_geojson_lakes_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_geojson_lakes",
    ...
    @cast_models
    def get_ogr_geojson_lakes_features(
        self,
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetOgrGeojsonLakesFeaturesProperties] = None,
        ...
        :type properties: List[GetOgrGeojsonLakesFeaturesProperties], optional
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_geojson_lakes/items",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def options_ogr_geojson_lakes_features(self) -> Any:
        """lakes of the world, public domain
    ...
    @cast_models
    def get_ogr_geojson_lakes_feature(
        self,
        feature_id: str,
        crs: str = None,
        f: GetLandingPageF = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_geojson_lakes/items/{{featureId}}",
                self.get_default_headers(),
            )
    ...
    @cast_models
    def options_ogr_geojson_lakes_feature(self, feature_id: str) -> Any:
        """lakes of the world, public domain
    ...
    @cast_models
    def get_ogr_geojson_lakes_queryables(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """lakes of the world, public domain
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_geojson_lakes/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def get_ogr_geojson_lakes_schema(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """lakes of the world, public domain
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_geojson_lakes/schema",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
