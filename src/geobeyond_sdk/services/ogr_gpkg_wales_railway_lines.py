...
class OgrGpkgWalesRailwayLinesService(BaseService):

    @cast_models
    def describe_ogr_gpkg_wales_railway_lines_collection(
        ...
        * An optional indicator about the type of the items in the collection (the default value, if the indicator is not provided, is 'feature').
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_railway_lines",
    ...
    @cast_models
    def get_ogr_gpkg_wales_railway_lines_features(
        self,
        ...
        crs: str = None,
        bbox_crs: str = None,
        properties: List[GetOgrGpkgWalesRailwayLinesFeaturesProperties] = None,
        ...
        :type properties: List[GetOgrGpkgWalesRailwayLinesFeaturesProperties], optional
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_railway_lines/items",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def options_ogr_gpkg_wales_railway_lines_features(self) -> Any:
        """Railway lines in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
    ...
    @cast_models
    def get_ogr_gpkg_wales_railway_lines_feature(
        self,
        feature_id: str,
        crs: str = None,
        f: GetLandingPageF = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_railway_lines/items/{{featureId}}",
                self.get_default_headers(),
            )
    ...
    @cast_models
    def options_ogr_gpkg_wales_railway_lines_feature(self, feature_id: str) -> Any:
        """Railway lines in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
    ...
    @cast_models
    def get_ogr_gpkg_wales_railway_lines_queryables(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Railway lines in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_railway_lines/queryables",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
    ...
    @cast_models
    def get_ogr_gpkg_wales_railway_lines_schema(
        self, f: GetLandingPageF = None, lang: Lang = None
    ) -> Queryables:
        """Railway lines in Wales (UK) from Ordnance Survey. Uses GeoPackage backend via OGR provider.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/ogr_gpkg_wales_railway_lines/schema",
                self.get_default_headers(),
            )
            .add_query("f", f, explode=False)
            .add_query("lang", lang)
